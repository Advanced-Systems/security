...
//            if (store == null)
//            {
//                return ValidateOptionsResult.Fail("Certificate store is not configured.");
//            }

//            X509Certificate2? certificate = this._certificateService.GetCertificate("default", options.Thumbprint, validOnly: false);
