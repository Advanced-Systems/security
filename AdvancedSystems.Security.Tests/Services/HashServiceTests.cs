...
{
    private readonly HashServiceFixture _fixture;
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        this._fixture.Logger.Verify(x => x.Log(
            LogLevel.Warning,
            It.IsAny<EventId>(),
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public void TestSHA256Hash()
    {
        ...
        // Act
        string sha256 = this._fixture.HashService.GetSHA256Hash(buffer);
    ...
    public void TestSHA384Hash()
    {
        ...
        // Act
        string sha384 = this._fixture.HashService.GetSHA384Hash(buffer);
    ...
    public void TestSHA512Hash()
    {
        ...
        // Act
        string sha512 = this._fixture.HashService.GetSHA512Hash(buffer);
